<template>
  ...
  <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 bg-white w-screen md:w-1/3 md:mx-auto">
    <div id="tabs" class="flex justify-between">
      <router-link :to="{path: '/pokedex'}" class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-1">
        ...
        <span class="tab tab-home block text-xs">Pokemon</span>
      </router-link>
      
      <router-link :to="{path: '/team'}" class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-1">
        <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="tab tab-kategori block text-xs">Team</span>
      </router-link>
      <router-link :to="{path: '/trade'}" class="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-1">
        <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="tab tab-explore block text-xs">Trade</span>
      </router-link>
    </div>
  </section>
</template>
